...
//   //userEvent.click(getByText(/episodes/i));

//   await waitFor(() => expect(queryAllByTestId(/episodes/i))
//     .toHaveLength(2))
//   expect(mockFetchShow).toHaveBeenCalledTimes(1)
// })

// test("renders a message for dropdown", () => {
//   const { getByText } = render(<App />)

//   expect(getByText(/select a season/i)).toBeInTheDocument();
//   expect(getByText(/select a option/i)).toBeInTheDocument();
// })